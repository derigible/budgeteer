...
public class CSVToTransactions implements Transformation {
	...
	/**
	 * Set the possible headers. This is used for extensibility to help make the CSVToTransactions
	 * class able to predict more column headers overtime and experience.
	 * 
	 * Pass in a array of String arrays, where the first position of the nest array refers to
	 * the possible value (as a String), and the second refers to the value header defined in the 
	 * following:
	 * 
	 * <pre>
	 * 		0 -> Date
