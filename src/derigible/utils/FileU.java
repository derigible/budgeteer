...
public final class FileU {
     ...
     * @throws IOException
     *             there was a problem in writing to the file
     */
     ...
     * @throws IOException
     *             a problem occurs when writing to the file
     */
    public static PrintWriter getFileWriterToDefaultLocation(String filename)
	    throws IOException {
     ...
     */
    public static BufferedReader getFileReaderAtDefaultLocation(String filename)
	    throws FileNotFoundException {
	File file = new File(System.getProperty("user.home") + "/Budgeteer");
	if (file.exists()) {
	    file = new File(file.getAbsolutePath() + "/" + filename);
     ...
     *             malformed URI
     */
    public static File getFileInJavaProjectFolder(String path)
	    throws URISyntaxException {
